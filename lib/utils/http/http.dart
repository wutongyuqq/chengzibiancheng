...
import 'package:getx/utils/http/connectivity_request_retrier.dart';
import 'package:getx/utils/http/error_interceptor.dart';
import 'package:getx/utils/http/proxy.dart';
import 'package:getx/utils/http/retry_interceptor.dart';
...
class Http {
  ...
  Map<String, dynamic> getAuthorizationHeader() {
    ...
    if (accessToken != null) {
      headers = {"Authorization": 'Bearer 0e63c03dfb66c4172b2b40b9f2344c45'};
    }
    return headers;
  }
